...
import com.jm.sgb.controllers.UnidadJpaController;
...
public class UnidadController implements Serializable {
    ...
    private UnidadJpaController jpaController = null;
    ...
    private UnidadJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new UnidadJpaController(utx, emf);
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getUnidadCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findUnidadEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getUnidadCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findUnidadEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findUnidadEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findUnidadEntities(), true);
    }
    ...
    public static class UnidadControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getJpaController().findUnidad(getKey(value));
        }
